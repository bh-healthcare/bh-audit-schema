...
- **v2.0 example corpus** -- 5 positive examples (`agent_mcp_patient_read`, `agent_ui_driving_note_write`, `human_override_agent_session`, `sub_agent_depth2_export`, `human_direct_read`) and 13 negative examples under `examples/2.0/negative/`, each the minimal counter-example for one schema rule.
